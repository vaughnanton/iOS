...
// if you're only writing Swift and don't need objective C, the Codable protocol for reading/writing is much easier
// codable works on both classes and structs
// when you encode data using Codable you can save in JSON format 
...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let savedPeople = defaults.object(forKey: "people") as? Data {
            // give the above instance to JSONDecoder to convert it back to object graph (array of Person objects)
            let jsonDecoder = JSONDecoder()
            
            do {
                // "attempt to creat an array of Person objects"
    ...
    func save() {
        ...
        // convert people array into Data object - if let and try? so we save data only when JSON conversion is successful
